...
int main() {
  ...
  if(gameWindow == NULL) {
    ...
    std::cout << "DD2 Auto G Up closing in 10 seconds..." << std::endl;
    Sleep(10000);
    return 0;
  }
  ...
  std::cout << "DD2 Auto G Up executing in 10 seconds..." << std::endl;
  Sleep(10000);
  std::cout << "DD2 Auto G Up executing NOW!" << std::endl;
  while(true) {
